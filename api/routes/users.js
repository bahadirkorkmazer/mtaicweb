...
router.post("/add", async (req, res) => {
  ...
  try {
    ...
    if (existingUser) {
      throw new CustomError(Enum.HTTP_CODES.CONFLICT, "Validation Error!", "This email is already registered");
    }
...
router.post("/delete", async (req, res) => {
  try {
    ...
    const existingUser = await Users.findById(body._id);
    if (!existingUser)
      throw new CustomError(Enum.HTTP_CODES.NOT_FOUND, "Delete Error!", "User not found");
